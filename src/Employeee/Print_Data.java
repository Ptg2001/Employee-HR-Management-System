...
class Print_Data implements ActionListener{
    JFrame f;
    JLabel id8,id,aid,id1,aid1,id2,aid2,id3,aid3,id4,aid4,id5,aid5,id6,aid6,id7,aid7,id9,id10,id11,id12,id13,id14,id15,id16,id17,aid10,lab;
    String emp_id,name,father,address,phone,email,education,post,age,dob,aadhar,dept_name;
    JButton b1,b2;
    ImageIcon icon;
    ...
    Print_Data(String e_id){
        ...
        id10= new JLabel("Department:");
        id10.setBounds(50,460,120,30);
        id10.setFont(new Font("serif",Font.BOLD,20));
        id9.add(id10);

        aid10= new JLabel(dept_name);
        aid10.setBounds(200,460,300,30);
